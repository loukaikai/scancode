...
/* 165 */     return ZonedDateTime.of(year, month, day, hour, minute, second, 0, ZoneId.systemDefault())
/* 166 */       .toInstant()
/* 167 */       .truncatedTo(ChronoUnit.SECONDS)
/* 168 */       .toEpochMilli();
/*     */   }
/*     */   
/*     */   long getCrc() {
/* 172 */     return Bytes.littleEndianValue(this.header, this.headerOffset + 16, 4);
/*     */   }
/*     */ 
/*     */   
/*     */   public long getCompressedSize() {
/* 177 */     return Bytes.littleEndianValue(this.header, this.headerOffset + 20, 4);
/*     */   }
/*     */ 
/*     */   
/*     */   public long getSize() {
/* 182 */     return Bytes.littleEndianValue(this.header, this.headerOffset + 24, 4);
/*     */   }
/*     */   
/*     */   byte[] getExtra() {
/* 186 */     return this.extra;
/*     */   }
/*     */   
/*     */   boolean hasExtra() {
/* 190 */     return (this.extra.length > 0);
/*     */   }
/*     */   
...
/* 199 */     return this.localHeaderOffset;
/*     */   }
/*     */ 
/*     */   
/*     */   public CentralDirectoryFileHeader clone() {
/* 204 */     byte[] header = new byte[46];
/* 205 */     System.arraycopy(this.header, this.headerOffset, header, 0, header.length);
/* 206 */     return new CentralDirectoryFileHeader(header, 0, this.name, header, this.comment, this.localHeaderOffset);
/*     */   }
/*     */ 
/*     */   
...
/* 211 */     CentralDirectoryFileHeader fileHeader = new CentralDirectoryFileHeader();
/* 212 */     byte[] bytes = data.read(offset, 46L);
/* 213 */     fileHeader.load(bytes, 0, data, offset, filter);
/* 214 */     return fileHeader;
/*     */   }
/*     */   
/*     */   private static int getChronoValue(long value, ChronoField field) {
/* 218 */     ValueRange range = field.range();
/* 219 */     return Math.toIntExact(Math.min(Math.max(value, range.getMinimum()), range.getMaximum()));
/*     */   }
/*     */ }


/* Location:              C:\Users\16509\Desktop\工作文档\稠州银行\代码文件\rwa-engine-1.0-SNAPSHOT\rwa-engine-1.0-SNAPSHOT.jar!\org\springframework\boot\loader\jar\CentralDirectoryFileHeader.class
